...
- **Character ID:** CH-001
- **Full name / aliases:** Foolish (Q!Foolish, to disambiguate from other continuities)
- **Played/voiced by:** Not recorded
- **Species/role/archetype:** Not yet established
- **Age:** Not yet established
- **Canon status:** Mixed — see tags throughout; this sheet currently rests on one source ([EV-0001](../01-canon-timeline/ev-0001-cruise-ship-first-meeting.md)).
...
- Eager, a little clumsy/self-deprecating when out of his depth (fumbling
  Spanish, laughing at himself) — [CANON FACT], seen directly in EV-0001 dialogue.
- Warm and open on first meeting people. [MY INTERPRETATION]
- Capable of guardedness/self-protection under the surface — see his
  private resolve in EV-0001. [MY INTERPRETATION]

## Speech patterns

- Speaks broken, learner-level Spanish; visibly figures out words as he
  goes ("Yo estoy… Eh, se muchas palabras en Español."). [CANON FACT]
- Reacts with short exclamations/laughter ("Oh! hohoho-", "Ah-"). [CANON FACT]

## Languages

- English (presumed native — not stated directly, [STRONG INFERENCE]
  based on Juan's read that Spanish isn't his first language).
- Spanish (limited/learner level, confirmed in EV-0001 dialogue). [CANON FACT]

## Recurring phrases

None established yet — too early in tracked history.
...
- Some working Spanish vocabulary, though limited. [CANON FACT]
- Survived "purgatory" on the QSMP1 island — implies resilience, not yet
  shown directly. [MY INTERPRETATION]

## Flaws

Not yet established beyond speculation about the attachment-avoidance
resolve.
...
|---|---|---|---|
| EV-0001 | REV-0001 (his own island/purgatory history) | Firsthand | [MY INTERPRETATION] |
| EV-0001 | REV-0004 (his own private resolve) | Firsthand | [MY INTERPRETATION] |

## What the audience knows that they do not

| Event ID / date | Revelation (REV-ID) | Character remains unaware until | Tag |
|---|---|---|---|
| EV-0001 | REV-0002 (full extent of Roier's memory loss) | Unresolved | [MY INTERPRETATION] |
| EV-0001 | REV-0003 (Juan's prison history) | Unresolved | [MY INTERPRETATION] |
...
This sheet leans heavily on narration rather than dialogue for anything
beyond the surface interaction — his island history, his feelings toward
Roier, and his private resolve are all framing supplied by the author,
not shown on-screen. Treat these as strong authorial intent for the story
rather than confirmed in-scene canon until/unless a future scene has him
state them directly.

## Writing notes

- Voice checklist: eager, a little goofy under pressure, willing to laugh
  at his own mistakes (esp. with language).
- Things to avoid: don't let his guardedness (the private resolve) leak
  into his surface dialogue yet — as of EV-0001 he plays warm and open;
  any coldness should be interior/dramatic-irony only until the story
