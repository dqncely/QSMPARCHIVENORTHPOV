...
- **Relationship ID:** REL-0001
- **Characters:** [Q!Foolish](../03-character-sheets/q-foolish.md) (CH-001), [Q!Juan](../03-character-sheets/q-juan.md) (CH-003)
- **Relationship type:** Complicated — rivals, colleagues, and (per author) close friends who "cosplay rivalry"; heavy romantic subtext by the author's own read, unconfirmed on-screen as of the latest tracked event.
- **Certainty level (overall):** Mixed. Early events (EV-0001, EV-0009 onward) are QNN-dated and confirmed; several mid-arc events are pending exact dates; the emotional throughline (trust, romantic subtext) is substantially the author's own interpretation layered on canon actions.

## Starting dynamic

- **As of (Event ID):** EV-0001
- First meeting, introduced by Roier. Easy, playful, no tension — Foolish fumbles Spanish, Juan corrects him warmly. Explicitly predates their later rivalry. [CANON FACT]
...
| EV-0064 | Foolish tells Juan everything about the Dark Cucurucho pact; Juan's instant, uncompromising rejection of the soul-cost is one of the clearest statements yet of what Foolish means to him | [CANON FACT] |
| EV-0066 | The altered-clothes scene — real, mutual, unspoken charge; Foolish notices Juan's tattoo and says nothing; both leave it unresolved | [CANON FACT] |

## Each person's perception of the other

### Q!Foolish's perception of Q!Juan

| As of (Event ID) | Perception | Tag |
|---|---|---|
| EV-0001 | Interesting, worth a second look | [CANON FACT] |
| EV-0030 | Trusts him enough to invite him into a genuinely risky joint venture (Federation info-gathering) | [MY INTERPRETATION] |

### Q!Juan's perception of Q!Foolish

| As of (Event ID) | Perception | Tag |
|---|---|---|
| EV-0001 | A bit strange, unthreatening, one of several "weirdos" | [CANON FACT] |
| EV-0009 | Someone capable of lying to him about something that matters | [CANON FACT] |
| EV-0028 | Someone he can be sincere with, once the audience is gone | [MY INTERPRETATION — pending transcript] |

## What Q!Foolish knows about Q!Juan

- His fluency/comfort code-switching Spanish/English, his role in the North, his temper, his capacity for real manipulation when he suspects a lie (EV-0009), his rare sincerity in private (EV-0028), and — as of EV-0030 — enough trust to bring him into Federation-related risk.

Foolish does not yet know (per tracked canon) the details of Juan's romantic history with the fake Cucurucho, or the full weight of what Juan told him in their final EV-0033 conversation before he disappeared (not recorded).

## What Q!Juan knows about Q!Foolish

- That Spanish isn't his first language; that he's capable of real betrayal for personal gain (EV-0009) but also real loyalty/protection (EV-0013); that he has a genuine history with the Federation and QSMP1 (EV-0030); that his claims of innocence aren't always reliable (EV-0017/EV-0018 contrast).

Juan does not yet know Foolish's private resolve not to get attached ([REV-0004](../11-continuity-tracking/rev-0004-foolish-private-resolve.md)) or the full truth behind his island/purgatory history ([REV-0001](../11-continuity-tracking/rev-0001-foolish-purgatory-history.md)).
...
**Scale used:** Low / Medium / High / Broken

| As of (Event ID) | A (Foolish) → B (Juan) trust | B (Juan) → A (Foolish) trust | Notes | Tag |
|---|---|---|---|---|
| EV-0001 | Low | Low | First meeting | [MY INTERPRETATION] |
| EV-0009 | — | Broken (temporarily) | Juan discovers Foolish lied about Estupidog | [MY INTERPRETATION] |
...
- Institutional (Juan's authority over Foolish within The North; the demotion). [CANON FACT]
- Petty/competitive (matching office designs, prank escalation). [CANON FACT]
- High-stakes (the Estupidog lie, the Regime plotting, the accidental/deliberate train death). [CANON FACT]
- Author has also indicated an earlier period of language-barrier conflict/"yelling at each other in a language the other didn't understand," predating the Spanglish merge referenced by the author — not yet represented by a specific dated event. **Flag: still needs its own timeline entry once identified/dated.**
...
> **F:** "Yo estoy… Eh, se muchas palabras en Español." / **J:** "Oh, nice.. Yo se muchas palabras en Inglés!"
> — [CANON FACT], EV-0001, source: [2026-03-14-cruise-ship-foolish-roier-juan-first-meeting.md](../02-transcripts/raw/2026-03-14-cruise-ship-foolish-roier-juan-first-meeting.md)

> **Foolish**, shouting: "Juan, Juan, I've got the train!"
> — [CANON FACT], EV-0017, per author (source pending exact QNN link)
...
- **Update, per author:** by EV-0066, both are "semi-aware" of their own feelings, though nothing has been named to the other. Juan tests the water in small ways without asking outright; Foolish either plays along casually or freaks out internally without showing it. Foolish is actively avoiding crossing an emotional threshold; Juan's hesitation is less about emotional risk and more about the professional/hierarchical line — he's technically Foolish's superior, and Vegetta (Foolish's own past) complicates it further. Their drunk behavior diverges in a way worth using deliberately: Juan gets bolder/more open when drunk, Foolish gets more withdrawn and more physically touchy rather than verbally open. [MY INTERPRETATION, per author]
...
- This is the fic's central pairing (estupiduo/sharkflower). Per author: both characters are broadly agreeable/warm people whose "rivalry" functions socially more like a bit than real hostility, laid over real, hard-won trust.
- Voice contrast to lean on: Juan's deflecting group-setting jokes vs. his sincere private register — a reliable well for dramatic irony and slow-burn pacing.
- Do not present the romantic-subtext material (see "Unresolved tension" above) as settled canon in any file outside `07-story-outlines/`, `08-prose-drafts/`, or this Writing Notes section.
